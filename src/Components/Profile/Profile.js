        ...
        <div className='sticky top-0'>
            ...
            <div className='my-5'>
                ...
                <div className='flex items-center justify-between bg-[#F2F4FA] p-2 my-4 rounded'>
                    ...
                    <h4 className="text-md bg-white hover:bg-blue-600 hover:text-white rounded-3xl p-3 text-black cursor-pointer">20s</h4>
                    <h4 className="text-md bg-white hover:bg-blue-600 hover:text-white rounded-3xl p-3 text-black cursor-pointer">30s</h4>
                    <h4 className="text-md bg-white hover:bg-blue-600 hover:text-white rounded-3xl p-3 text-black cursor-pointer">40s</h4>
                </div>
            </div>
            {/* Exercise Data */}
            <div className='my-5'>
